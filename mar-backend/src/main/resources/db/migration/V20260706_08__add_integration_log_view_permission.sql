insert into permissions (
    ...
    ('00000000-0000-0000-0000-000000000229', 'integration_log.view', 'View integration log', 'Read webhook and integration event logs for troubleshooting', 'ACTIVE')
...
with default_profiles(role_code, function_code, access_level, scope) as (
    values
        ('ADMIN', 'integration_log.view', 'VIEW', 'TENANT'),
        ('CEO', 'integration_log.view', 'VIEW', 'TENANT'),
        ('MARKETING', 'integration_log.view', 'VIEW', 'TENANT')
),
tenant_profiles as (
    select
        tenants.tenant_id,
